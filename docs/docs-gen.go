...
// In this case, reflects goxjt.Metadata{}.
//
//nolint:exhaustruct
func GenerateTypeSchemas() error {
	...
	reflector, err := GenerateReflector(
		"github.com/beyondcivic/goxjt/pkg/goxjt", "../pkg/goxjt",
	)
	if err != nil {
		return err
	}
	...
	// schema := reflector.Reflect(&goxjt.Metadata{})
...
func GoMarkDoc() error {
	...
	repo := lang.Repo{
		Remote:        "https://github.com:beyondcivic/goxjt",
		DefaultBranch: "main",
		PathFromRoot:  "",
	}
